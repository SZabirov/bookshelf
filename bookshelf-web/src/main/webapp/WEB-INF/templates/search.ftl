...
<div id="main" class="wrapper style1">
    <div class="searchform">
        <input type='text' name='search' class='searchfield' placeholder='Автор' required><br />
        <input type='text' name='search' class='searchfield' placeholder='Название книги' required><br />
